...
| Equipment slot / wearable item | [equipment.md](equipment.md) |
| Container / key / door / light | [world-objects.md](world-objects.md) |
| Edit definitions files (skills, classes, species…) in the browser | [definitions-editor.md](definitions-editor.md) |
| Build or edit an area file in the browser | [area-builder.md](area-builder.md) |
| Scripted NPC behaviour (Lua) | [scripting.md](scripting.md) |
| Room entry event (Lua) | [scripting.md](scripting.md) |
| Skill effect in Lua instead of C# | [scripting.md](scripting.md) |

Other references: [persistence.md](persistence.md), [leveling.md](leveling.md) (XP + character creation), [tuning.md](tuning.md) (engine balance constants), [area-builder.md](area-builder.md) (web tool + CLI wizard for area authoring), [definitions-editor.md](definitions-editor.md) (web tool for definitions authoring), [scripting.md](scripting.md) (Lua scripting for NPCs, rooms, and skills), [teams.md](teams.md) (multi-body spirit — design, not yet built).
