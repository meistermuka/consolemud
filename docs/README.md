...
Other references: [persistence.md](persistence.md), [leveling.md](leveling.md) (XP + character creation), [tuning.md](tuning.md) (engine balance constants), [area-builder.md](area-builder.md) (interactive area creation), [teams.md](teams.md) (multi-body spirit — design, not yet built).
