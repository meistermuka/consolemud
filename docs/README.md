...
Other references: [persistence.md](persistence.md), [leveling.md](leveling.md) (XP + character creation), [tuning.md](tuning.md) (engine balance constants), [area-builder.md](area-builder.md) (web tool + CLI wizard for area authoring), [definitions-editor.md](definitions-editor.md) (web tool for definitions authoring), [teams.md](teams.md) (multi-body spirit — design, not yet built).
